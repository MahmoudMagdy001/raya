...
(
    ...
    '9:16',
    ARRAY['https://images.unsplash.com/photo-1579783902614-a3fb3927b675?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1542744094-3a31f272c490?auto=format&fit=crop&w=800&q=80'],
    true,
    1,
    3500000,
    '2025-11-15',
...
(
    ...
    'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=200&q=80',
    'تغطية المعارض والمؤتمرات',
...
('الهيئة العامة للترفيه', 'GEA • SAUDI ARABIA', 1, 'published'),
('الهيئة العامة للمنشآت (منشآت)', 'MONSHAAT', 2, 'published'),
('شركة إتقان القابضة للاستثمار', 'ITQAN HOLDING', 3, 'published'),
('مجموعة دار النخبة العقارية', 'AL NUKHBA REAL ESTATE', 4, 'published'),
('دار وجد للأزياء الراقية', 'WAJD HAUTE COUTURE', 5, 'published'),
('دار سمو للعطور الفاخرة', 'SUMOU LUXURY PARFUMS', 6, 'published'),
('سلسلة مقاهي رسيل المختصة', 'RASEEL SPECIALTY COFFEE', 7, 'published'),
('القمة العالمية للذكاء الاصطناعي', 'GLOBAL AI SUMMIT', 8, 'published'),
('شركة مسار للحلول الرقمية', 'MASAR DIGITAL SOLUTIONS', 9, 'published'),
('بنك التنمية الاجتماعية', 'SDB • SOCIAL DEV BANK', 10, 'published'),
('مجموعة روشن العقارية', 'ROSHN REAL ESTATE GROUP', 11, 'published'),
('وزارة الثقافة السعودية', 'MINISTRY OF CULTURE', 12, 'published'),
('موسم الرياض الترفيهي', 'RIYADH SEASON', 13, 'published'),
('شركة جاهز الدولية', 'JAHEZ INTERNATIONAL', 14, 'published')
